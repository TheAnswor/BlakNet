...
export const PLANS: PlanTier[] = [
  {
    ...
    tagline: "Connect, share and grow your business.",
    cta: "Get Started Free",
    features: [
      { label: "Personal social account", included: true },
      { label: "Create business pages", included: true },
      { label: "1 business page", included: true },
      { label: "1 team account (owner)", included: true },
      { label: "Newsfeed, posts & engagement", included: true },
      { label: "Follow businesses & people", included: true },
      { label: "Events & resources", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Up to 3 business pages", included: true, badge: "Popular" },
      { label: "Up to 3 team accounts", included: true },
      { label: "Add more accounts at extra cost", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Up to 5 business pages", included: true },
