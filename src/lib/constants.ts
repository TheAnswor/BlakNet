...
export const PLANS: PlanTier[] = [
  {
    ...
    features: [
      ...
      { label: "WhatsApp enquiry button", included: false },
    ],
  },
  {
    id: "VERIFIED",
    ...
    features: [
      ...
      { label: "Verified review badge", included: true },
      { label: "WhatsApp enquiry button", included: true },
      { label: "Go Live on Hustle Feed", included: true },
      { label: "Real-time notifications", included: true },
      { label: "Export Intelligence Hub", included: true },
    ],
  },
  {
    id: "INTELLIGENCE",
    ...
    features: [
      ...
      { label: "Transaction signal tracking", included: true, badge: "Soon" },
