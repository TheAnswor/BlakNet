        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              <Button
                type="submit"
                className="h-11 rounded-full bg-cream px-5 text-ink hover:bg-cream/90"
              >
                Search
              </Button>
            </form>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <Button
                ...
                className="bg-sage text-cream hover:bg-sage/90"
              >
          ...
          {/* stats strip */}
          <div className="mx-auto mt-16 grid max-w-4xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-cream/10 bg-cream/10 sm:grid-cols-4">
            {STATS.map((s) => (
              <div key={s.label} className="bg-ink/40 px-4 py-6 text-center backdrop-blur">
                <div className="font-display text-3xl tracking-tight text-cream">{s.value}</div>
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-display text-3xl text-foreground/15">{c.step}</span>
                  <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-ink text-cream">
                    <c.icon className="h-5 w-5" />
                  </div>
                </div>
                <h3 className="mt-6 font-display text-2xl tracking-tight">{c.title}</h3>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            />
            <Button variant="outline" onClick={() => navigate({ name: "directory" })} className="self-start sm:self-end">
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-cream/10 bg-cream/10 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={c.title} className="bg-ink/40 p-6 backdrop-blur transition-colors hover:bg-ink/60">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-sage/15 text-sage">
                  <c.icon className="h-5 w-5" />
                </div>
                <h3 className="mt-4 font-display text-xl tracking-tight text-cream">{c.title}</h3>
      ...
      <section className="bg-cream-grain">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-ink font-display text-cream">
              T
            </div>
            <div className="text-left">
              <div className="text-sm font-semibold">Thandiwe Mokoena</div>
              <div className="text-xs text-muted-foreground">Founder, Lwazi Cloud Systems</div>
            </div>
          </div>
        </div>
      </section>
